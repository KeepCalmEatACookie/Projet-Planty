...
/* MODIFICATION DU HEADER */
 ...
 // Récupération de la liste des items du menu actuel nom qui est donné au menu dans WP  ocean: "site-header")
 ...
 function menu_item_admin ( $items, $args ) {
		 ...
		 if (is_user_logged_in()) {
			...
			while ( false !== ( $item_pos = strpos ( $items, '<li', 10 ) ) ) {
			 ...
			 $items_array[] = $items;
			 // On insère le lien 'Admin' à la position indiquée ici c'est 1 pour qu'il soit en première place dans le tableau.
